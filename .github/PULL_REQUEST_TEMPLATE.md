...
Describe en qué distro/entorno lo probaste y qué casos verificaste (autostart de usuario, de sistema, systemd, cron...).
...
- [ ] Pasé `shellcheck` sobre `script/Autostart_Manager.sh` y no introduje warnings nuevos
